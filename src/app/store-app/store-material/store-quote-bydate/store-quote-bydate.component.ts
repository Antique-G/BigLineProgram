...
export class StoreQuoteBydateComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.activatedRoute.queryParams.subscribe(params => {
            this.include_insurance_fee = params.include_insurance_fee;
            this.insurance_expense = params.insurance_expense;
                ...
                const modal: NzModalRef = this.modal.create({
                    ...
                    nzComponentParams: {
                        data: {
                            ...
                            include_insurance_fee: this.include_insurance_fee,
