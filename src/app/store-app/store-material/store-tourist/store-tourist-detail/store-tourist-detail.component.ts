...
@Component({
  selector: 'app-store-tourist-detail',
  templateUrl: './store-tourist-detail.component.html',
  styleUrls: ['./store-tourist-detail.component.css']
})
export class StoreTouristDetailComponent implements OnInit {
  addForm!: FormGroup;
  disabledClick = false;
  paracont = '发送验证码';
  isCodeValue = 'show';
