...
@Component({
  selector: 'app-store-order-group-change-price',
  templateUrl: './store-order-group-change-price.component.html',
  styleUrls: ['./store-order-group-change-price.component.css']
})
export class StoreOrderGroupChangePriceComponent implements OnInit {
  @Input() data: any;
  addForm!: FormGroup;
  dataDetail: any;
  isId: any;
