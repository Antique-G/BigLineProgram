...
import { StoreInsuranceDetailComponent } from '../../store-product-create-bystep/store-product-info/store-insurance-detail/store-insurance-detail.component';
...
export class StoreProductManagementDetailInfoComponent implements OnInit {
    ...
    buildForm(): void {
        this.addForm = this.fb.group({
            ...
            insurance_extra: [''],
            sales_note: [''],
            is_group: ['0', [Validators.required]],
        });
        // 每次表单数据发生变化的时候更新错误信息
    ...
    setFormValue() {
        ...
        this.addForm.get('include_insurance_fee')?.setValue(this.dataProductDetailModel.include_insurance_fee);
