...
@Component({
  selector: 'app-admin-tourist-create',
  templateUrl: './admin-tourist-create.component.html',
  styleUrls: ['./admin-tourist-create.component.css']
})
export class AdminTouristCreateComponent implements OnInit {
  status = '1';
  addForm!: FormGroup;
  disabledClick = false;
  paracont = '发送验证码';
  ...
  add() {
    ...
    this.adminTouristService.addTourist( this.addTouristModel).subscribe(res=>{
      console.log("res",res)
      if (res === null) {
        // alert("创建成功");
