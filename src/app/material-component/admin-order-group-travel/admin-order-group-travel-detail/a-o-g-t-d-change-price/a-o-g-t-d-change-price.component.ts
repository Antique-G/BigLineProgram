...
@Component({
  selector: 'app-a-o-g-t-d-change-price',
  templateUrl: './a-o-g-t-d-change-price.component.html',
  styleUrls: ['./a-o-g-t-d-change-price.component.css']
})
export class AOGTDChangePriceComponent implements OnInit {
  @Input() data: any;
  addForm!: FormGroup;
  dataDetail: any;
  isId: any;
