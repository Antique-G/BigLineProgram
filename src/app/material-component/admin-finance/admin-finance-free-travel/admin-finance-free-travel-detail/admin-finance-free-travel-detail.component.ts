...
@Component({
  selector: 'app-admin-finance-free-travel-detail',
  templateUrl: './admin-finance-free-travel-detail.component.html',
  styleUrls: ['./admin-finance-free-travel-detail.component.css']
})
export class AdminFinanceFreeTravelDetailComponent implements OnInit {
