...
export class AdminFinanceGoodsRequestMoneyComponent implements OnInit {
        ...
        this.adminProductManagementService.storeList('').subscribe(res => {
            ...
            this.adminOrderGroupTravelService.getAdminOptData().subscribe(res => {
                ...
                this.adminGoodsService.getCateListTree().subscribe(res => {
                    ...
                    this.cateList = res;
                    if (JSON.parse(localStorage.getItem("adminGoodsOrderCashRequestSearch")!) == null) {
                        // 第一次进来页面
    ...
    getOrderList() {
        this.adminGoodsService.cashRequireList(this.page, this.per_page, this.order_status, this.order_id, this.express_status,
