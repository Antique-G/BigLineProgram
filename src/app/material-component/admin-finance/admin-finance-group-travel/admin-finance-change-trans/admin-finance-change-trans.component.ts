...
@Component({
    selector: 'app-admin-finance-change-trans',
    templateUrl: './admin-finance-change-trans.component.html',
    styleUrls: ['./admin-finance-change-trans.component.css']
})
export class AdminFinanceChangeTransComponent implements OnInit {
    @Input() data: any;
    dataSource: any[] = [];
    ...
    constructor(public modal: NzModalService, public adminFinaceGroupService: AdminFinaceGroupService) {
    ...
    saveEdit(data: any) {
        ...
        this.modal.confirm({
            ...
            nzOnOk: () => this.adminFinaceGroupService.changeTrans(this.comfirmOrderModel).subscribe(res => {
