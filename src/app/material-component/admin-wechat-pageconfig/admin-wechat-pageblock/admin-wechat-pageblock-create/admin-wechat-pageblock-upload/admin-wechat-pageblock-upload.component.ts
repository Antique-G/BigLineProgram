...
@Component({
  selector: 'app-admin-wechat-pageblock-upload',
  templateUrl: './admin-wechat-pageblock-upload.component.html',
  styleUrls: ['./admin-wechat-pageblock-upload.component.css']
})
export class AdminWechatPageblockUploadComponent implements OnInit {
  addForm!: FormGroup;
  isLoadingBtn = false;
  ...
  constructor(public dialogRef: MatDialogRef<AdminWechatPageblockUploadComponent>, private msg: NzMessageService,
