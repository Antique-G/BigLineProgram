...
import { EditContractModel, StoreAccountChangeJobModel, StoreAccountDetailModel, StoreApplyCertifiDetailListModel, StoreApplyCertifiDetailModel, StoreApplyCertifiModel, StoreApplyRequestModel } from '../../../interfaces/store/storeApply/store-apply-model';
...
export class StoreApplyService {
    ...
    // 修改工号
    changeJob(storeAccountChangeJobModel: StoreAccountChangeJobModel): Observable<any> {
        return this.httpClient.post<any>(this.urls.PostStoreChangeJobNum, storeAccountChangeJobModel, httpOptions)
            .pipe(
                catchError(this.handleError)
            );
    }
