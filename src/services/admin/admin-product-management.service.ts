...
export class AdminProductManagementService {
    ...
    // 产品列表
    productList(page: number, per_page: number, status: any, check_status: any, title: string, store_id: string, code: any,
        few_days: any, tag?: any, departure_city?: any, destination_city?: any): Observable<AdminProductManagementListResponseModel> {
