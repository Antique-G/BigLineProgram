...
export class AdminProductFreeTravelService {
  ...
  // 自由行产品列表
  freeTravelList(page: number, per_page: number, status: any, check_status: any, title: string, store_name: string, code: any, few_days: any, tag?: any): Observable<AdminFreeTravelListResponseModel> {
